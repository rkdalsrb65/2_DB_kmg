...
SELECT DEPARTMENT_NAME 학과별, CAPACITY 정원
FROM TB_DEPARTMENT;
...
SELECT STUDENT_NAME
FROM TB_STUDENT
JOIN TB_DEPARTMENT ON (DEPARTMENT_CODE  = DEPARTMENT_NO)
WHERE DEPARTMENT_NAME IN ('국어국문학과') AND SUBSTR(DEPARTMENT_NO, 8, 1) = '2';
