...
DROP TABLE DEPARTMENT2; -- 잘못 롤백했을 때
...
-- SELECT INSERT DELETE UPDATE 꼭 외울 것
...
BONUS = (SELECT BONUS FROM EMPLOYEE2 WHERE EMP_NAME = '유재식') -- WHERE절 직전 컬럼 작성 후 콤마(,) X
WHERE EMP_NAME = '방명수';
...
DELETE FROM DEMPLOYEE2; --> WHERE 미작성 시 전체 삭제
--> 24행 삭제
