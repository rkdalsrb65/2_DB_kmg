...
-- ALTER TABLE 테이블명 DROP COLUMN삭제할컬럼명;
...
VALUES('010', '개발1팀', 'L1', DEFAULT, DEFAULT);
...
-- DEPT_COPY 테이블에 PK 추가(컬럼 : DPT_ID , 제약조건명 : D_COPY_PK)
...
-- 2) 관계가 형성된 테이블 삭제
CREATE TABLE TB1(TB1_PK NUMBER PRIMARY KEY, TB1_COL NUMBER);
CREATE TABLE TB2(TB2_PK NUMBER PRIMARY KEY, TB2_COL NUMBER REFERENCES TB1);
