...
CREATE TABLE "MEMBER_HOLD" (
   ...
   "HOLD_FL"   CHAR(1)   DEFAULT 'N'   NOT NULL
);
...
ALTER TABLE "BOARD_TYPE" ADD CONSTRAINT "FK_MAIN_CATEGORY_TO_BOARD_TYPE_1" FOREIGN KEY (
   "MAIN_CATEGORY_NO"
)
...
ALTER TABLE "BOARD_TYPE" ADD CONSTRAINT "FK_MEMBER_LEVEL_TO_BOARD_TYPE_1" FOREIGN KEY (
   "MEMBER_LEVEL_NO"
)
REFERENCES "MEMBER_LEVEL" (
   "MEMBER_LEVEL_NO"
...
ALTER TABLE "LOGIN_HISTORY" ADD CONSTRAINT "FK_MEMBER_TO_LOGIN_HISTORY_1" FOREIGN KEY (
   "MEMBER_NO"
)
REFERENCES "MEMBER" (
   "MEMBER_NO"
...
ALTER TABLE "TEMP_POST" ADD CONSTRAINT "FK_BOARD_TO_TEMP_POST_1" FOREIGN KEY (
   "BOARD_NO"
)
REFERENCES "BOARD" (
   "BOARD_NO"
...
ALTER TABLE "MEMBER_SECESSION" ADD CONSTRAINT "FK_MEMBER_TO_MEMBER_SECESSION_1" FOREIGN KEY (
   "S_MEMBER_NO"
)
REFERENCES "MEMBER" (
   "MEMBER_NO"
...
ALTER TABLE "MEMBER_SECESSION" ADD CONSTRAINT "FK_MEMBER_TO_MEMBER_SECESSION_2" FOREIGN KEY (
   "S_MANAGER_NO"
)
REFERENCES "MEMBER" (
   "MEMBER_NO"
...
ALTER TABLE "WRITING_FORM" ADD CONSTRAINT "FK_WRITING_FORM_TYPE_TO_WRITING_FORM_1" FOREIGN KEY (
   "WRITING_FORM_NO"
)
...
ALTER TABLE "WRITING_FORM" ADD CONSTRAINT "FK_BOARD_TYPE_TO_WRITING_FORM_1" FOREIGN KEY (
   "BOARD_CODE"
)
REFERENCES "BOARD_TYPE" (
   "BOARD_CODE"
